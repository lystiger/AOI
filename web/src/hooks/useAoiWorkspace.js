...
export function useAoiWorkspace() {
  ...
  return {
    ...
    handleRunInspection: actions.handleRunInspection,
    ...
    isInspecting: actions.isInspecting,
    ...
    requiresFovsDraft: actions.requiresFovsDraft,
    ...
    setRequiresFovsDraft: actions.setRequiresFovsDraft,
